...
Source0  : https://files.pythonhosted.org/packages/c6/aa/8d598e7338fb9677a9084c27d86e51f3732c541be161d77a24e28f23b6f2/acme-4.0.0.tar.gz
...
%prep
%setup -q -n acme-4.0.0
cd %{_builddir}/acme-4.0.0
pushd ..
cp -a acme-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744120883
