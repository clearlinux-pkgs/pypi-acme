...
Source0  : https://files.pythonhosted.org/packages/60/95/6261bf7f8794ead92e56b76d4b5e2a237e3b3b9edb0bc9b7fc249e8a24d1/acme-2.7.2.tar.gz
...
%prep
%setup -q -n acme-2.7.2
cd %{_builddir}/acme-2.7.2
pushd ..
cp -a acme-2.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697824445
