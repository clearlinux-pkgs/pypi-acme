...
Source0  : https://files.pythonhosted.org/packages/fd/8e/166279430adea94c9fa72079fcef10f5d0a382faaa233ef9e99c3210c108/acme-2.6.0.tar.gz
...
%prep
%setup -q -n acme-2.6.0
cd %{_builddir}/acme-2.6.0
pushd ..
cp -a acme-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684607181
