...
Source0  : https://files.pythonhosted.org/packages/d2/b4/a4a923e7dd24733b522fdd23a7ce5ba6105b5f41acacc8890adedc3ebb4c/acme-2.9.0.tar.gz
...
%prep
%setup -q -n acme-2.9.0
cd %{_builddir}/acme-2.9.0
pushd ..
cp -a acme-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707497740
