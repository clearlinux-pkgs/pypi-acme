...
Source0  : https://files.pythonhosted.org/packages/fc/56/64e8e0e10e90e9adf5801ec32534c6465e2f4438f3bd1278f0fc284cceeb/acme-1.32.0.tar.gz
...
%prep
%setup -q -n acme-1.32.0
cd %{_builddir}/acme-1.32.0
pushd ..
cp -a acme-1.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668009106
