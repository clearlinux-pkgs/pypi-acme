...
Source0  : https://files.pythonhosted.org/packages/f1/eb/7731d7e3c099adaaa814ecf12bd1f6741605b8d80e9b33b69a51849cf280/acme-2.10.0.tar.gz
...
%prep
%setup -q -n acme-2.10.0
cd %{_builddir}/acme-2.10.0
pushd ..
cp -a acme-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712243013
