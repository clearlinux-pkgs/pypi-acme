...
Source0  : https://files.pythonhosted.org/packages/c9/5b/731cd971fd8fbb543be9d6e2bcba71d2d5dd01d454cb7ad9b0953fd6d21b/acme-3.3.0.tar.gz
...
%prep
%setup -q -n acme-3.3.0
cd %{_builddir}/acme-3.3.0
pushd ..
cp -a acme-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741711451
