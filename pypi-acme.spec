...
Source0  : https://files.pythonhosted.org/packages/5d/98/6088bc807a987b8c5d8a1607618aecff5af7c1df775cc8c082c075914190/acme-1.24.0.tar.gz
...
%prep
%setup -q -n acme-1.24.0
cd %{_builddir}/acme-1.24.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646239005
...
cp %{_builddir}/acme-1.24.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-acme/d095fa0d394cc9417a65aecd0d28e7d10e762f98
