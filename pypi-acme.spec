...
Source0  : https://files.pythonhosted.org/packages/58/02/8441b42614d77c8cf539b3345376a02ca8d676906bd883e94a2a11859d0b/acme-1.25.0.tar.gz
...
%prep
%setup -q -n acme-1.25.0
cd %{_builddir}/acme-1.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647527508
...
cp %{_builddir}/acme-1.25.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-acme/d095fa0d394cc9417a65aecd0d28e7d10e762f98
