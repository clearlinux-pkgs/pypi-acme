...
Source0  : https://files.pythonhosted.org/packages/f9/6a/c94be0e8ee157f3c7721844863589c627c40bfa10d8838faeb6b28b59bb2/acme-3.2.0.tar.gz
...
%prep
%setup -q -n acme-3.2.0
cd %{_builddir}/acme-3.2.0
pushd ..
cp -a acme-3.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739341156
